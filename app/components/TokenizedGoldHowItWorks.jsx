      ...
      <div className="tghiw__container">
        <div className="tghiw__header sr-item" style={{ animationDelay: "0.08s" }}>
          <div className="tghiw__tag-wrap">
            ...
            <p className="tghiw__tag-label">How It Works</p>
          </div>
          <h2 className="tghiw__title">Finding home should feel simple</h2>
        </div>
        ...
        <div className="tghiw__feature sr-item" style={{ animationDelay: "0.34s" }}>
          <div className="tghiw__feature-image-wrap">
            <img
              ...
              src="https://framerusercontent.com/images/t0Ze2dHrAtbW7dOFiDqa65YYes.png?width=1260&height=872"
              alt="Property style showcase visual"
              loading="lazy"
            />
          </div>
          <div className="tghiw__feature-content">
            <p className="tghiw__eyebrow">Tokenized {commodityName} Service Built Around People</p>
            <h3 className="tghiw__feature-title">Find Clarity and Confidence in Every Decision</h3>
            <p className="tghiw__feature-body">
              Toto Finance is built on a simple mission: make access to trusted gold ownership transparent, global, and easy
              to understand.
            </p>
            <a
            ...
            >
              <span>Explore {commodityName}</span>
